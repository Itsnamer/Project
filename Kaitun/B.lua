...
task.spawn(LPH_NO_VIRTUALIZE(function()
	while task.wait(1) do
		...
		if Function["AI"]["Enabled"] then
			...
			elseif Function["AI"]["Select"] == "Chest" and Readied and MyMoney >= 405 then
...
task.spawn(function()
  while true do
    if request and _G.KaitunConfig["Webhook"]["Enabled"] and _G.KaitunConfig["Webhook"]["Url"] ~= "" then
      ...
      if success then
        print("Webhook sent:", res and res.StatusCode)
      else
    ...
    task.wait(_G.KaitunConfig["Webhook"]["Delay"])
  end
end)

print("true")
print("kaitun script v.0.0.3")
